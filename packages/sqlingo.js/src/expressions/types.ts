...
export enum ExpressionKey {
  ...
  CATALOG_PROPERTY = 'catalogProperty',
  CBRT = 'cbrt',
  CEIL = 'ceil',
  CHANGES = 'changes',
  ...
  COMMIT = 'commit',
  COMPUTE_PROPERTY = 'computeProperty',
  ...
  HANDLER_PROPERTY = 'handlerProperty',
  ...
  MASKING_PROPERTY = 'maskingProperty',
  ...
  PARAMETER_STYLE_PROPERTY = 'parameterStyleProperty',
  ...
  ROUND = 'round',
  ROW_ACCESS_PROPERTY = 'rowAccessProperty',
  ...
  SECURITY_INTEGRATION_PROPERTY = 'securityIntegrationProperty',
  SELECT = 'select',
  ...
  TRIGGER_REFERENCING = 'triggerReferencing',
  TRIM = 'trim',
  TRUNC = 'trunc',
