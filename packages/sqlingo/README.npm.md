...
![SQLGlot](https://img.shields.io/badge/SQLGlot-v30.1.0-blue)
...
This package tracks [SQLGlot](https://github.com/tobymao/sqlglot) v30.1.0 (commit `8726250`). The API surface mirrors SQLGlot's Python API, adapted to TypeScript conventions. See [CONVENTION.md](https://github.com/huydo862003/sqlingo/blob/master/packages/sqlingo/CONVENTION.md) for details.
